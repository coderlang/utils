...
export class IdNumber {
  ...
  public isValid():boolean {
    ...
    let idDigits:string[] = this.str.split('');
    //∑(ai×Wi)(mod 11)
    //加权因子
    let factor:number[] = [ 7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2 ];
    //校验位
    let check:string[] = [ '1', '0', 'x', '9', '8', '7', '6', '5', '4', '3', '2'];
  ...
  public getBirthdayTimestamp():number {
  ...
  public getGender():IdNumberGender {
  ...
  private checkAdcode():boolean {
    ...
    // 81:"香港",82:"澳門",91:"國外"
    const allAdcode:Set<string> = new Set<string>(["11", "12", "13", "14", "15"
